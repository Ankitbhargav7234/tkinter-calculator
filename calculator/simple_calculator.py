...
button_sub=Button(root,text="-",padx=40,pady=20,command=button_sub).grid(row="4",column="1")
button_mul=Button(root,text="*",padx=40,pady=20,command=button_mul).grid(row="4",column="2")
...
button_equal=Button(root,text="=",padx=92,pady=20,command=button_equal).grid(row="6",column="1",columnspan=3)
button_clear=Button(root,text="Clear",padx=83,pady=20,command=button_clear).grid(row="5",column="1",columnspan=3)
